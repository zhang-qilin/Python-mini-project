...
class SetUI(object):
    ...
    def set_ui(self):
        ...
        file_menu.add_command(label='Python小项目合集', command=lambda: webbrowser.open('https://github.com/zhang-qilin/Python-mini-project'))
        file_menu.add_command(label='关于作者', command=lambda: webbrowser.open('https://github.com/zhang-qilin'))
